...
resumesRouter.get("/", resumesController.resumeAllGet); // 이력서 전체 조회 api
...
resumesRouter.get("/:id", resumesController.resumePlusGet); // 이력서 상세 조회 api
...
resumesRouter.put("/:id", updateResumeValidator, resumesController.resumePut); //이력서 수정 api
// resumesRouter.put(
//   "/:id",
...
resumesRouter.delete("/:id", resumesController.resumeDelete); //이력서 삭제 api
...
resumesRouter.get("/:id/logs", requireRoles([USER_ROLE.RECRUITER]), resumesController.resumeLogs); // 이력서 로그
// resumesRouter.get(
//   "/:id/logs",
//   requireRoles([USER_ROLE.RECRUITER]),
//   async (req, res, next) => {
