...
authrouter.post("/sign-up", singUpValidator, authController.signUp); //회원가입 api
// authrouter.post(
//   "/sign-up",
//   singUpValidator,
//   async (req, res, next) => {
...
// authrouter.post("/sing-in", singUpValidator, authController.singIn()); //로그인 api

authrouter.post("/sign-in", singInValidator, authController.signIn); //로그인 api
// authrouter.post(
//   "/sign-in",
//   singInValidator,
//   async (req, res, next) => {
